...
- A front-end subnet can use a system route to access the internet. 
- A back-end subnet can use a system route to access the front-end subnet. 
...
- Traffic between virtual machines 
  - in the same subnet
  - **in different subnets in the same virtual network**
