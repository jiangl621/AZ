...
1. DNS record : a rule that says where to send your domain name.  
It is composed of   
...
1. Record Set : Group of bunch of records
![Alt text](image-20.png)
1. DNS zone : a container for all your DNS records for a specific domain name
