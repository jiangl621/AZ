...
**An Azure virtual network is a logical isolation of the Azure cloud resources**.  You can 
...
1. define IP address 
   ...
   2. Once you create the IP address space, it can't be changed. If you plan your address space for cloud-only virtual networks, you might later decide to connect an on-premises site.
...
There are two types of Azure IP addresses : Azure can provide an IP address (dynamic assignment) or you can assign the IP address (static assignment).
