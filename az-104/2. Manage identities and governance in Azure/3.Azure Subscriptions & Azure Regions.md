...
1. learn about supported Azure regions, and how to locate Azure services. 
2. review the features and use cases for Azure subscriptions, and how to obtain subscriptions. 
3. explore features and billing for different types of Azure subscriptions, and how to apply resource tagging. 
4. discover how Microsoft Cost Management can be used for cost analysis and learn how to identify ways you can reduce your billing costs.
...
### Azure global infrastructure website 

Help you find supported regions for your business geography.
...
You can obtain an Azure subscription as part of an `Enterprise agreement`, or through a `Microsoft reseller` or `Microsoft partner`. Users can also open a `personal free account` for a trial subscription.

### Azure Subscription Choices

The most common subscriptions are `Free`, `Pay-As-You-Go`, `Enterprise Agreement`, and Student. For your organization, you can choose a combination of procurement options and subscription choices to meet your business scenarios.
r
#### Considerations
...
- Recommendations can reveal less expensive resource options. When you act on the recommendations, you change the way you use your resources to save money. Using recommendations is an easy process:
...
You could have the tag name Server and the value Production or Development, and then apply the tag/value pair to your Engineering computer resources.
...
- Group resources like virtual machines by cost center and production environment.   
...
Azure Credits  
- Use the monthly credit benefit to develop, test, and experiment with new solutions on Azure. With your monthly Azure credit, Azure is your personal sandbox for development and testing.
